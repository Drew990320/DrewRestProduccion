...
export declare const ACTION_ICON_KEYS: readonly ["pedido_agregar_menu", "pedido_agregar_bebidas", "pedido_abrir_mesa", "pedido_abrir_pedido", "pedido_pasar_cocina", "pedido_reimprimir_comanda", "pedido_cobrar", "pedido_ver_pedido", "pedido_nuevo_para_llevar", "pedido_nueva_venta_bebidas", "pedido_cliente_autoservicio", "accion_reimprimir", "accion_reimprimir_comanda", "accion_reimprimir_total_pedido", "accion_reimprimir_cobro", "accion_guardar", "accion_cancelar", "accion_consultar", "accion_llamar_mesero", "accion_ir_mesa", "accion_ir_cocina", "accion_confirmar_en_mesa", "accion_falta_en_cocina", "resumen_elegir_impresion", "resumen_imprimir_todas", "resumen_totales_caja", "admin_crear", "admin_crear_mesero", "admin_cancelar", "admin_confirmar", "admin_volver_mesas", "admin_activar", "admin_desactivar", "admin_ver_hoy", "admin_entrar", "admin_probar_api", "admin_ir_menu", "admin_eliminar", "admin_editar", "admin_guardar", "admin_restablecer", "pago_efectivo", "pago_transferencia", "pago_tarjeta", "pago_mixto", "pago_fiado", "pago_redondeo", "tienda_gestionar", "tienda_nueva_venta", "tienda_abrir_catalogo", "tienda_cobrar"];
