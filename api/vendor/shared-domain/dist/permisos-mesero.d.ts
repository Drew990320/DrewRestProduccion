...
export declare const PERMISOS_MESERO_KEYS: readonly ["agregar_items", "editar_cantidades", "quitar_lineas", "enviar_cocina", "reimprimir_comanda", "cobrar", "precuenta", "reimprimir_factura", "cancelar_pedido", "transferir_mesa", "ayuda_companeros"];
