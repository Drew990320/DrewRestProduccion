...
exports.HELP_MANIFEST_SCREENS = [
    ...
    { id: 'categorias_admin', moduleId: 'admin_catalogo', title: 'Categorías y disponibilidad', prioridad: 30, patron: '/categorias-admin', roles: ['admin'], signalOnEnter: 'categorias_admin.en_pantalla', route: '/(app)/categorias-admin', viaMoreMenu: true, moreNavTarget: 'more.categorias_admin' },
    ...
    { id: 'inventario', moduleId: 'admin_operacion', title: 'Bodega', prioridad: 45, patron: '/(?:inventario|recursos)(?:/|$)', roles: ['admin'], signalOnEnter: 'inventario.en_pantalla', route: '/(app)/recursos', navTarget: 'nav.recursos' },
    { id: 'compras', moduleId: 'admin_operacion', title: 'Compras', prioridad: 50, patron: '/(?:compras|ingreso-stock)(?:/|$)', roles: ['admin'], signalOnEnter: 'compras.en_pantalla', route: '/(app)/compras', viaMoreMenu: true },
...
exports.HELP_MANIFEST_TARGETS = [
    ...
    { id: 'nav.inventario', label: 'Bodega', kind: 'nav', activateOnPress: true },
    { id: 'nav.recursos', label: 'Bodega', kind: 'nav', activateOnPress: true },
    ...
    { id: 'more.categorias_admin', label: 'Categorías y disponibilidad', kind: 'more', activateOnPress: true },
    ...
    { id: 'inventario.agregar_item', label: 'Nuevo producto / insumo', kind: 'action', screenIds: ['inventario'], activateOnPress: true, relatedSignals: ['inventario.tiene_items'] },
    { id: 'inventario.movimiento_entrada', label: 'Entrada de stock', kind: 'action', screenIds: ['inventario'], activateOnPress: true },
